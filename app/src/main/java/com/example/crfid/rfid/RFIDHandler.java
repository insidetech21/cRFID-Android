...
class RFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private MaterialTagPair_ItemDetail context;
    // general
    ...
    String readerName = "RFD4031-G10B700-JP";
     ...
     public
     void onCreate ( MaterialTagPair_ItemDetail activity ) {
        // application context
        context = activity;
        // Status UI
        textView = activity.tagidTV;
        // SDK
        InitSDK();
    }
    ...
    private class CreateInstanceTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            readers = new Readers(context.requireContext (), ENUM_TRANSPORT.ALL);
            try {
            ...
            if (invalidUsageException != null) {
                ...
                readers = null;
                if (readers == null) {
                    readers = new Readers(context.requireContext (), ENUM_TRANSPORT.BLUETOOTH);
                }
            }
            return null;
        }

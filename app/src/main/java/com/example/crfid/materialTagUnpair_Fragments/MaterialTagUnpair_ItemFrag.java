...
public
class MaterialTagUnpair_ItemFrag extends Fragment {
    ...
    MaterialTagUnPairItemAdaptor adapter;
    ...
    View onCreateView ( LayoutInflater inflater , ViewGroup container ,
        ...
        return inflater.inflate ( R.layout.fragment_material_tag_unpair__item ,
                container ,
                false );
    }
    ...
    void onViewCreated ( @NonNull View view , @Nullable Bundle savedInstanceState ) {
        ...
        recyclerView=view.findViewById ( R.id.TagUnPairItemRecy );
        progressBar=view.findViewById ( R.id.progressBarfragItemUnpair );
...
//                ArrayList<MaterialTagPair_Item> result = new ArrayList<> ( arr );
                ...
                if (filteredWarehouseOrders.isEmpty()) {
                    ...
                    adapter = new MaterialTagUnPairItemAdaptor (filteredWarehouseOrders);
...
//                pleasewait.setVisibility ( View.INVISIBLE );
    ...
    void onResume () {
        ...
        result.clear ( );
        adapter = new MaterialTagUnPairItemAdaptor ( result );
        recyclerView.setAdapter ( adapter );
        MatTagItemFragRetrofit ();
    }
    class MaterialTagUnPairItemAdaptor extends RecyclerView.Adapter<MaterialTagUnPairItemAdaptor.ViewHolder> {
        private final List<MaterialTagPair_Item> data;

        MaterialTagUnPairItemAdaptor ( List<MaterialTagPair_Item> data ) {
            this.data = data;
        }
        ...
        @Override
        public
        MaterialTagUnPairItemAdaptor.ViewHolder onCreateViewHolder ( @NonNull ViewGroup parent , int viewType ) {
            View view = LayoutInflater.from ( parent.getContext ( ) ).inflate ( R.layout.recy_item_for_mat_tag_pair_frag_item ,
                    parent ,
                    false );
            return new MaterialTagUnPairItemAdaptor.ViewHolder ( view );
        }

        @Override
        public
        void onBindViewHolder ( @NonNull MaterialTagUnPairItemAdaptor.ViewHolder holder , int position ) {
